...
using eegs_back_end.Economic_Enterprises.Slaughterhouse.PostMortem.Repository;
...
namespace eegs_back_end.Economic_Enterprises.Slaughterhouse.PostMortem.Controller
{
    [Route("slaughterhouse/post_mortem")]
    [ApiController]
    public class PostMortemController : ControllerBase
    {
        // GET: api/<PostMortemController>
        IPostMortemRepository _repo;
        public PostMortemController(IPostMortemRepository repo)
        {
            _repo = repo;
        }
        ...
        [HttpPost]
        public IActionResult Post([FromBody] PostMortemModel value)
        {
        ...
        [HttpPut("{id}")]
        public IActionResult Put(string id, [FromBody] PostMortemModel value)
        {
