...
using eegs_back_end.Economic_Enterprises.Slaughterhouse.Issuance.Repository;
...
namespace eegs_back_end.Economic_Enterprises.Slaughterhouse.Issuance.Controller
{
    [Route("slaughterhouse/issuance")]
    [ApiController]
    public class IssuanceController : ControllerBase
    {
        // GET: api/<IssuanceController>
        IIssuanceRepository _repo;
        public IssuanceController(IIssuanceRepository repo)
        {
            _repo = repo;
        }
        ...
        [HttpPost]
        public IActionResult Post([FromBody] IssuanceModel value)
        {
        ...
        [HttpPut("{id}")]
        public IActionResult Put(string id, [FromBody] IssuanceModel value)
        {
