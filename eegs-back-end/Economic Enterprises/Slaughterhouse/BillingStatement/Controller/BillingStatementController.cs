...
using eegs_back_end.Economic_Enterprises.Slaughterhouse.BillingStatement.Repository;
...
namespace eegs_back_end.Economic_Enterprises.Slaughterhouse.BillingStatement.Controller
{
    [Route("slaughterhouse/billing_statement")]
    [ApiController]
    public class BillingStatementController : ControllerBase
    {
        // GET: api/<BillingStatementController>
        IBillingStatementRepository _repo;
        public BillingStatementController(IBillingStatementRepository repo)
        {
            _repo = repo;
        }
        ...
        [HttpPost]
        public IActionResult Post([FromBody] BillingStatementModel value)
        {
        ...
        [HttpPut("{id}")]
        public IActionResult Put(string id, [FromBody] BillingStatementModel value)
        {
