...
namespace eegs_back_end.Admin.PwdIntakeSetup.Model
{
    public class PwdIntakeModel
    {
        public string pwd_intake_guid { get; set; }
        ...
        public List<PwdIntakeDetails> details { get; set; }
    }

    public class PwdIntakeDetails
    {
