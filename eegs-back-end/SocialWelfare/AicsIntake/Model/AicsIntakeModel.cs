...
namespace eegs_back_end.Admin.AicsIntakeSetup.Model
{
    public class AicsIntakeModel
    {
        ...
        public List<AicsIntakeDetails> details { get; set; }
    }

    public class AicsIntakeDetails
    {
