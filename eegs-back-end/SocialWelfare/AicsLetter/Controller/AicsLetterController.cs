...
using eegs_back_end.Admin.AicsLetterSetup.Repository;
...
namespace eegs_back_end.Admin.AicsLetterSetup.Controller
{
    [Route("social_welfare/aics_letter")]
    [ApiController]
    public class AicsLetterController : ControllerBase
    {
        byte[] FileAsByteArray;
        IAicsLetterRepository _repo;
        public AicsLetterController(IAicsLetterRepository repo)
        {
            _repo = repo;
        }
        // GET: api/<AicsLetterController>
        [HttpGet]
        ...
        [HttpGet("AicsLetter_details/{GUID}")]
        ...
        // GET api/<AicsLetterController>/5
        [HttpGet("{aics_letter_guid}")]
        public object GetAicsLetter(string aics_letter_guid)
        {
            return _repo.GetAicsLetter(aics_letter_guid);
        }

        // POST api/<AicsLetterController>
        [HttpPost]
        public IActionResult Post([FromBody] AicsLetterModel model)
        {
        ...
        // PUT api/<AicsLetterController>/5
        [HttpPut("{id}")]
        public IActionResult Put(string id, [FromBody] AicsLetterModel value)
        {
        ...
        // DELETE api/<AicsLetterController>/5
