...
namespace eegs_back_end.Admin.IndigentIntakeSetup.Model
{
    public class IndigentIntakeModel
    {
        public string indigent_intake_guid { get; set; }
        ...
        public List<IndigentIntakeDetails> details { get; set; }
    }

    public class IndigentIntakeDetails
    {
