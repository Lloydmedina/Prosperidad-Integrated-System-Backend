...
namespace eegs_back_end.Admin.AicsSetup.Model
{
    public class AicsModel
    {
        public string aics_guid { get; set; }
        ...
        public List<AicsDetails> family_details { get; set; }
        public List<CasualtiesDetails> casualties_details { get; set; }
    }

    public class AicsDetails
    {
    ...
    public class CasualtiesDetails
    {
        public string main_guid { get; set; }
        public string person_guid { get; set; }
        public string prefix { get; set; }
