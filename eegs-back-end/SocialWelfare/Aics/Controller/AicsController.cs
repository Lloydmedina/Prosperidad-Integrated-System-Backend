...
using eegs_back_end.Admin.AicsSetup.Repository;
...
namespace eegs_back_end.Admin.AicsSetup.Controller
{
    [Route("social_welfare/aics")]
    [ApiController]
    public class AicsController : ControllerBase
    {
        byte[] FileAsByteArray;
        IAicsRepository _repo;
        public AicsController(IAicsRepository repo)
        {
            _repo = repo;
        }
        // GET: api/<AicsController>
        [HttpGet]
        ...
        // GET api/<AicsController>/5
        [HttpGet("{aics_guid}")]
        public object GetAics(string aics_guid)
        {
            return _repo.GetAics(aics_guid);
        }

        // POST api/<AicsController>
        [HttpPost]
        public IActionResult Post([FromBody] AicsModel model)
        {
        ...
        // PUT api/<AicsController>/5
        [HttpPut("{id}")]
        public IActionResult Put(string id, [FromBody] AicsModel value)
        {
