...
using eegs_back_end.Admin.DafacIntakeSetup.Repository;
...
namespace eegs_back_end.Admin.DafacIntakeSetup.Controller
{
    [Route("social_welfare/dafac_intake")]
    [ApiController]
    public class DafacIntakeController : ControllerBase
    {
        byte[] FileAsByteArray;
        IDafacIntakeRepository _repo;
        public DafacIntakeController(IDafacIntakeRepository repo)
        {
            _repo = repo;
        }
        // GET: api/<DafacIntakeController>
        [HttpGet]
        ...
        [HttpGet("dafac_intake_details/{GUID}")]
        ...
        // GET api/<DafacIntakeController>/5
        [HttpGet("{general_intake_guid}")]
        public object GetDafacIntake(string general_intake_guid)
        {
            return _repo.GetDafacIntake(general_intake_guid);
        }

        // POST api/<DafacIntakeController>
        [HttpPost]
        public IActionResult Post([FromBody] DafacIntakeModel model)
        {
        ...
        // PUT api/<DafacIntakeController>/5
        [HttpPut("{id}")]
        public IActionResult Put(string id, [FromBody] DafacIntakeModel value)
        {
        ...
        // DELETE api/<DafacIntakeController>/5
