...
namespace eegs_back_end.Admin.DafacIntakeSetup.Model
{
    public class DafacIntakeModel
    {
        public string dafac_intake_guid { get; set; }
        ...
        public List<DafacIntakeDetails> details { get; set; }
    }

    public class DafacIntakeDetails
    {
