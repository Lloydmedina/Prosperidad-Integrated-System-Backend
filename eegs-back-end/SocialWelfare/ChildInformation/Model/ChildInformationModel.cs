...
namespace eegs_back_end.Admin.ChildInformationSetup.Model
{
    public class ChildInformationModel
    {
        ...
        public List<ChildInformationDetails> family_details { get; set; }
    }

    public class ChildInformationDetails
    {
