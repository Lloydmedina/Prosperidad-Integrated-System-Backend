...
using eegs_back_end.Admin.ChildInformationSetup.Repository;
...
namespace eegs_back_end.Admin.ChildInformationSetup.Controller
{
    [Route("social_welfare/child_info")]
    [ApiController]
    public class ChildInformationController : ControllerBase
    {
        byte[] FileAsByteArray;
        IChildInformationRepository _repo;
        public ChildInformationController(IChildInformationRepository repo)
        {
            _repo = repo;
        }
        // GET: api/<ChildInformationController>
        [HttpGet]
        ...
        // GET api/<ChildInformationController>/5
        [HttpGet("{child_info_guid}")]
        public object GetChildInformation(string child_info_guid)
        {
            return _repo.GetChildInformation(child_info_guid);
        }

        // POST api/<ChildInformationController>
        [HttpPost]
        public IActionResult Post([FromBody] ChildInformationModel model)
        {
        ...
        // PUT api/<ChildInformationController>/5
        [HttpPut("{id}")]
        public IActionResult Put(string id, [FromBody] ChildInformationModel value)
        {
        ...
        // DELETE api/<ChildInformationController>/5
