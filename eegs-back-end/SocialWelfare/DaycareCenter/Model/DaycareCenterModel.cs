...
namespace eegs_back_end.Admin.DaycareCenterSetup.Model
{
    public class DaycareCenterModel
    {
        ...
        public List<DaycareCenterDetails> family_details { get; set; }
    }

    public class DaycareCenterDetails
    {
