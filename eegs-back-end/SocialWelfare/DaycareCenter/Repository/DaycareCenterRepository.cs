...
namespace eegs_back_end.Admin.DaycareCenterSetup.Repository
{
    public interface IDaycareCenterRepository :IGlobalInterface
    {
        bool Insert(DaycareCenterModel model);
        ...
        bool Edit(string GUID, DaycareCenterModel model);
        bool Delete(string GUID);
        object GetDaycareCenter(string DaycareCenter_guid);
    }
    public class DaycareCenterRepository : FormNumberGenerator, IDaycareCenterRepository
    {
        public bool Edit(string GUID, DaycareCenterModel model)
        {
        ...
        {
            string sql = "UPDATE mswd.DaycareCenter SET status = 'Deleted' where mswd.DaycareCenter.DaycareCenter_guid = @DaycareCenter_guid";
        ...
        {
            string sql = @"SELECT mswd.daycare_center.daycare_center_guid, mswd.daycare_center.form_trans_no, mswd.daycare_center.application_date, mswd.daycare_center.status
            FROM mswd.daycare_center
            WHERE mswd.daycare_center.`status` = 'Active' ORDER BY mswd.daycare_center.id DESC;";

            List<object> obj = (List<object>)QueryModule.DataSource<object>(sql);

            ExpandoObject form = Forms.getForm("daycare-center");
        ...
        public object GetDaycareCenter(string child_info_guid)
        {
            ...
            var obj = (DaycareCenterModel)QueryModule.DataObject<DaycareCenterModel>(sql, new { child_info_guid = child_info_guid });
            ...
            obj.family_details = (List<DaycareCenterDetails>)QueryModule.DataSource<DaycareCenterDetails>(sql);
        ...
        public object GetPersonAdd(string GUID)
        {
            ...
            var obj = (DaycareCenterModel)QueryModule.DataObject<DaycareCenterModel>(sql);
            ...
            //obj.details = (List<DaycareCenterDetails>)QueryModule.DataSource<DaycareCenterDetails>(sql);
        ...
        public bool Insert(DaycareCenterModel model)
        {
            if (QueryModule.connection.State == System.Data.ConnectionState.Open)
            {
                QueryModule.connection.Close();
