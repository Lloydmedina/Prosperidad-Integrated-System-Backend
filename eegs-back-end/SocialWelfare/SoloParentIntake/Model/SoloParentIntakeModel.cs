...
namespace eegs_back_end.Admin.SoloParentIntakeSetup.Model
{
    public class SoloParentIntakeModel
    {
        public string solo_parent_intake_guid { get; set; }
        ...
        public List<SoloParentIntakeDetails> details { get; set; }
    }

    public class SoloParentIntakeDetails
    {
