...
using eegs_back_end.Admin.GeneralIntakeSetup.Repository;
...
namespace eegs_back_end.Admin.GeneralIntakeSetup.Controller
{
    [Route("social_welfare/general_intake")]
    [ApiController]
    public class GeneralIntakeController : ControllerBase
    {
        byte[] FileAsByteArray;
        IGeneralIntakeRepository _repo;
        public GeneralIntakeController(IGeneralIntakeRepository repo)
        {
            _repo = repo;
        }
        // GET: api/<GeneralIntakeController>
        [HttpGet]
        ...
        // GET api/<GeneralIntakeController>/5
        [HttpGet("{general_intake_guid}")]
        public object GetGeneralIntake(string general_intake_guid)
        {
            return _repo.GetGeneralIntake(general_intake_guid);
        }

        // POST api/<GeneralIntakeController>
        [HttpPost]
        public IActionResult Post([FromBody] GeneralIntakeModel model)
        {
        ...
        // PUT api/<GeneralIntakeController>/5
        [HttpPut("{id}")]
        public IActionResult Put(string id, [FromBody] GeneralIntakeModel value)
        {
        ...
        // DELETE api/<GeneralIntakeController>/5
