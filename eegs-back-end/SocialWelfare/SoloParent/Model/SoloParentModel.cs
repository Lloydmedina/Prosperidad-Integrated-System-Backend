...
namespace eegs_back_end.Admin.SoloParentSetup.Model
{
    public class SoloParentModel
    {
        ...
        public List<SoloParentDetails> family_details { get; set; }
    }

    public class SoloParentDetails
    {
